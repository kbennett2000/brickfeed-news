...
/**
 * A record is "generated" only when ALL four generation fields are present and
 ...
 * Generator for {headline, description, imagePrompt}, wrap the neutral imagePrompt
 * with the configured brick style, and write all four fields back together. Pure:
